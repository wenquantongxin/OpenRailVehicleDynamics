...
|---|---:|---:|
| 八轮零转矩被动 | `0.009–0.013 / 0.154 mm` | `0.015–0.019 / 0.097 mrad` |
...
|---|---:|---:|---:|
| 八轮零转矩被动 | `0.360 / 40.338 kN` | `0.031 / 2.538 kN` | `0.101 / 11.299 kN` |
...
| IRW 八轮零转矩被动，30 s | `26.694 s / 1.124×` | `33.120 s / 0.906×` | `33.17 s / 0.904×` | `158.30 s / 0.190×` |
