...
class RotationMatrix {
 public:
  ...
  void PostMultiplyByAxialRotation(const RotationMatrix<T>& aR_BC,
    ...
    // This axial path uses fewer operations than general composition.
  ...
  /// R_AC, then this method returns R_BC = R_AB⁻¹ * R_AC. It uses the transpose
  /// implied by rotation-matrix orthogonality instead of computing a general
  /// inverse.
