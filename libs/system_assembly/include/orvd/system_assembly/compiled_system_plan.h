...
/// typed vehicle-force plan, optional frozen typed wheel--rail and
/// independent-wheel active-torque plans, and no event-producing component.
/// Its static order evaluates every admitted force once, assembles the
/// resulting body wrenches, and evaluates
...
class CompiledSystemPlan {
   public:
    ...
    /// v, z or any context-local input.  Whether that context is
    ...
    /// vehicle, contact and active-torque plans; a caller who wants an
    /// arbitrary research or test wrench calls the multibody facade directly
    /// one layer below.
    ///
