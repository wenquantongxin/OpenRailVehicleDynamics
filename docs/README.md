...
| [planning/rail_vehicle_dynamics_migration/MIGRATION_ROADMAP.md](planning/rail_vehicle_dynamics_migration/MIGRATION_ROADMAP.md) | **现行车辆迁移路书**：6 个子目标、9 个原子 Goal（G47–G55）；已由项目负责人启用，G49 已完成，当前暂停于 G50 前；它是唯一带「当前 Goal」的进度权威。 |
